...
function LX = fbtxsparc(t,L)
 ...
 LX.t       = 1;            % Time in pulse (s)
 CS1_current = 33147;       % Amps
 
 %% Equilibrium scalars
 LX.rBt     = 12.2*P.r0;    % R B_T (Tesla - m)
 LX.Ip      = 1.0e6 ;       % Plasma current (A)
 LX.qA      = 2.7;          % Central q
 LX.bp      = 0.080;        % Beta poloidal (%)
 ...
 a0 = 0.427;                % Midplane minor radius (m)
 ...
 X_flux = -1.;             % Flux at the X-points

 sp_flux = -1.;            % Flux at strikepoints
 ...
 LX.gpia(15:16) = -10136;        % DIV1 Current in Amps
 LX.gpia(17:18) = -11623;        % DIV2 Current in Amps
