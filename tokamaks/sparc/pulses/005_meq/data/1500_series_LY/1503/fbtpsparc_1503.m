...
function P = fbtpsparc(shot,P)
 ...
 P.dissi   = 1e-17;     % Relative weight for coil current constraints
 P.dipol   = 1e-11;     % Relative weight for the dipole constraint
 P.tol     = 1e-3;      % Solution tolerance
 ...
 %   P' function
 pprime = linspace(1,0.0,n).^0.55;   % 1 at core, 0 at edge
 %pprime(1:17) = pprime(17);         % Flatten core
 % pprime(n-2:n-1) = 2.0;           % H-mode Pedestal
 ...
 P.limm = 0.8*ones(na,1); % Max and Min x 0.9
