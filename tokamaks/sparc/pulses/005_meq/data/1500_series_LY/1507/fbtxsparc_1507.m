...
function LX = fbtxsparc(t,L)
 ...
 LX.t       = 7;            % Time in pulse (s)
 CS1_current = -24658;      % Amps
 
 %% Equilibrium scalars
 LX.rBt     = 12.2*P.r0;    % R B_T (Tesla - m)
 LX.Ip      = 7.0e6 ;       % Plasma current (A)
 LX.qA      = 1.0;          % Central q
 LX.bp      = 0.046;        % Beta poloidal (%)
 ...
 a0 = 0.57;                 % Midplane minor radius (m)
 ...
 LX.gpdw = 2*ones(na,1);      % Simple current dipoles
