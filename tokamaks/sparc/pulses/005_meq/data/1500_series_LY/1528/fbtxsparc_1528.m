...
function LX = fbtxsparc(t,L)
 ...
 X_flux = -.7;              % Flux at the X-points
 
 r_shift = -0.2;
 sp_flux = -.7;             % Flux at strikepoints
