...
function LX = fbtxsparc(t,L)
 ...
 X_flux = -.9;              % Flux at the X-points
 
 r_shift = -0.3;
 sp_flux = -.9;             % Flux at strikepoints
