...
function LX = fbtxsparc(t,L)
 ...
 X_flux = -1.1;              % Flux at the X-points
 
 r_shift = -0.3;
 sp_flux = -1.1;             % Flux at strikepoints
