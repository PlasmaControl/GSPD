...
function LX = fbtxsparc(t,L)
 ...
 X_flux = -.5;              % Flux at the X-points
 
 r_shift = -0.1;
 sp_flux = -.5;             % Flux at strikepoints
