...
s.t0 = 0.2;                       % start time
s.tf = 30;                        % end time
s.N = 100;                        % number of timepoints (equilibria), more than 100 takes a while
...
s.fds2control = {'ic', 'diff_psicp_psix1', 'diff_psicp_psix2', 'diff_psicp_psitouch', ...
  'psibry', 'psix_r', 'psix_z', 'diff_psix1_psix2'}';
...
s.ic_max = [45*ones(1,14) 32*ones(1,4) 10]' * 1000 * 1.1;
s.ic_min = -[45*ones(1,14) 32*ones(1,4) 10]' * 1000 * 1.1;
