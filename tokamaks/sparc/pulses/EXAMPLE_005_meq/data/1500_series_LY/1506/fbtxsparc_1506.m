...
function LX = fbtxsparc(t,L)
 ...
 LX.t       = 6;            % Time in pulse (s)
 CS1_current = -15678;      % Amps
 
 %% Equilibrium scalars
 LX.rBt     = 12.2*P.r0;    % R B_T (Tesla - m)
 LX.Ip      = 6.0e6 ;       % Plasma current (A)
 LX.qA      = 1.0;          % Central q
 LX.bp      = 0.053;        % Beta poloidal (%)
 ...
 X_flux = -.35;               % Flux at the X-points

 sp_flux = -.35;            % Flux at strikepoints
